...
<section className="relative bg-gray-900 text-white overflow-hidden min-h-[420px] flex items-end pb-16 pt-32">
  <div className="absolute inset-0 z-0">
    <img src="https://images.unsplash.com/photo-1468493858157-0da44aaf1d13?q=80&w=1171&auto=format&fit=crop" className="w-full h-full object-cover" alt="Dental Implant Services" />
