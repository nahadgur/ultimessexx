  ...
  return (
    <div className="min-h-screen bg-white text-slate-700">
      ...
      <div className="pb-24 bg-white">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm mx-4 sm:mx-0 p-10 md:p-14">
          <h2 className="text-2xl font-display font-bold text-gray-900 mb-6 text-center">{service.title} in {cityName}: What Patients Need to Know</h2>
          <div className="grid lg:grid-cols-2 gap-10 text-gray-600 leading-relaxed text-[15px]">
            <div className="space-y-4">
              <p>Dental implants are the only tooth replacement that addresses bone loss alongside aesthetics. When a tooth is extracted, the jawbone beneath begins to resorb within weeks — losing width first, then height. A bridge or denture replaces the visible crown but does nothing to preserve the underlying bone. An implant post transmits chewing forces directly into the bone, maintaining its density and protecting the long-term facial structure. Choosing {service.title.toLowerCase()} in {cityName} now prevents the accelerating bone loss that makes future treatment progressively more complex and expensive.</p>
              <p>The quality of {service.title.toLowerCase()} available in {cityName} varies significantly between providers. General practices that place implants occasionally as a side offering typically lack the diagnostic equipment and accumulated case volume of specialist-focused clinicians. Every practice in our {cityName} network uses in-house CBCT 3D scanning — mapping bone density, nerve canals, and sinus anatomy to sub-millimetre precision before surgery. This is the foundation of predictable, complication-free placement.</p>
            </div>
            <div className="space-y-4">
              <p>Ten-year survival rates for implants placed by experienced clinicians consistently exceed 97%. The two most common failure modes — peri-implantitis and early loading failure — are both substantially reduced by rigorous case selection and structured aftercare. Every treatment plan provided by our {cityName} specialists includes a 12-week integration review, bite assessment at crown fitting, and annual hygiene monitoring as standard. Success is not a given — it is a protocol.</p>
              <p>Considering {service.title.toLowerCase()} in {cityName} but uncertain about eligibility or cost? Many patients told they are unsuitable — due to bone loss, age, or systemic health factors — are reassessed by our specialists and found to be viable candidates with appropriate preparatory treatment. Our matching service connects you with a {cityName} clinician who can review your specific situation and provide a written preliminary assessment, at no cost and no obligation.</p>
            </div>
          </div>
        </div>
